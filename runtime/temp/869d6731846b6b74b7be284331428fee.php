<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"C:\phpStudy\PHPTutorial\WWW\shuzi\public/../application/admin\view\project\index.html";i:1517325921;s:85:"C:\phpStudy\PHPTutorial\WWW\shuzi\public/../application/admin\view\public\header.html";i:1516803117;s:85:"C:\phpStudy\PHPTutorial\WWW\shuzi\public/../application/admin\view\public\footer.html";i:1512649436;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <!--新增用户信息开始-->
                    <form class="form-horizontal" name="projectAdd" id="projectAdd" method="post" action="<?php echo url('projectAdd'); ?>">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <!--新增用户信息开始-->
                    <form class="form-horizontal" name="level2Add" id="level2Add" method="post" action="<?php echo url('nodeAdd'); ?>">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <!--新增用户信息开始-->
                    <form class="form-horizontal" name="level3Add" id="level3Add" method="post" action="<?php echo url('nodeAdd'); ?>">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <!--新增用户信息开始-->
                    <form class="form-horizontal" name="level4Add" id="level4Add" method="post" action="<?php echo url('nodeAdd'); ?>">
...
//删除
    ...
    function del(that) {
        var uid = $(that).parent("td").parent("tr").children("td:first-child").text();
        myconfirm(uid,'<?php echo url("projectDel"); ?>');
    }
//组织结构
    var zTreeObj;
...
<script>
        uploader = WebUploader.create({
            ...
            server: "<?php echo url('Project/importExcel'); ?>",// 文件接收服务端。
            chunked: false,
