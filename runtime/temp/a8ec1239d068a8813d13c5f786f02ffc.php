<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"C:\phpStudy\PHPTutorial\WWW\shuzi\public/../application/admin\view\index.html";i:1517503150;s:85:"C:\phpStudy\PHPTutorial\WWW\shuzi\public/../application/admin\view\public\header.html";i:1516803117;s:85:"C:\phpStudy\PHPTutorial\WWW\shuzi\public/../application/admin\view\public\footer.html";i:1512649436;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="menu">
                    ...
                    <ul class="nav nav-second-level">
                        <?php if(!empty($vo['child'])): if(is_array($vo['child']) || $vo['child'] instanceof \think\Collection || $vo['child'] instanceof \think\Paginator): if( count($vo['child'])==0 ) : echo "" ;else: foreach($vo['child'] as $key=>$v): if(empty($v['grandchild'])): ?>
                        <li>
                        ...
                        <li class="menu">
                            <a href="<?php echo $v['href']; ?>">
                                ...
                                <span class="fa arrow" style="margin-right: 5px;"></span>
                            </a>
                            <ul class="nav nav-third-level">
                                <?php if(!empty($v['grandchild'])): if(is_array($v['grandchild']) || $v['grandchild'] instanceof \think\Collection || $v['grandchild'] instanceof \think\Paginator): if( count($v['grandchild'])==0 ) : echo "" ;else: foreach($v['grandchild'] as $key=>$vv): ?>
                                <li>
