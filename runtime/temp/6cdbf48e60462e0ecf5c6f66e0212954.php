...
<p style="line-height: 30px;font-weight: 700;">安全文化建设</p>
...
<script>
    var admin_table = $('#admin_table').DataTable( {
        ...
        "serverSide": true,
        "ajax": {
            "url": "__SCRIPT__/safety_responsibility_culture.php"
        },
