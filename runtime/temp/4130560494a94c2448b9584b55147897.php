<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"C:\phpStudy\PHPTutorial\WWW\shuzi\public/../application/files\view\fileshou5\index.html";i:1517675489;s:85:"C:\phpStudy\PHPTutorial\WWW\shuzi\public/../application/files\view\public\header.html";i:1517675489;s:85:"C:\phpStudy\PHPTutorial\WWW\shuzi\public/../application/files\view\public\footer.html";i:1517500912;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div id="container">
    <ul class="nav nav-tabs" id="myTab">
        <li class="active"><a href="#home">物探</a></li>
        <li><a href="#profile">土建</a></li>
        <li><a href="#messages">金属结构</a></li>
    </ul>
...
<div id="mycontent" style="width: 20%;height: 98%;display: inline-block;margin: 0 10px;background-color:#fff;overflow-x: scroll;padding-top: 20px;padding-right:10px;border-right: 1px solid #ccc;">
    <div style="text-align: center;background-color:#1ab394;line-height: 30px;color: #fff;">第三方实验室来文分类结构</div>
    <div id="file_per"></div>
...
<script type="text/javascript">
    $('#myTab a').click(function (e) {
        ...
        var admin_table = $('#admin_table').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "__SCRIPT__/fileshou1.php"
            },
            "dom": '<"mybtn btn btn-outline btn-primary"><"mybtn2 btn btn-outline btn-primary"><"myl"l><"mysel">frtip',
            "columnDefs": [
                {
                    "searchable": false,
                    "orderable": false,
