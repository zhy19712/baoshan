<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"C:\phpStudy\PHPTutorial\WWW\shuzi\public/../application/admin\view\menu\index.html";i:1517325921;s:85:"C:\phpStudy\PHPTutorial\WWW\shuzi\public/../application/admin\view\public\header.html";i:1516803117;s:85:"C:\phpStudy\PHPTutorial\WWW\shuzi\public/../application/admin\view\public\footer.html";i:1512649436;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="col-sm-12">   
                    <div  class="col-sm-2">
                        <div class="input-group" >  
                            <button type="button" class="btn btn-primary btn-outline" data-toggle="modal" data-target="#myModal">添加权限</button>
                        </div>
                    </div>                                                                                        
                </div>
            </div>
                    ...
                    <div class="ibox-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <span class="help-block m-b-none">如：admin/user/adduser (一级节点添加“#”，二级节点添加“##”)</span>
                                </div>
                            </div>  
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="css" id="css" placeholder="输入权限名称前显示的CSS样式" class="form-control"/>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        function checkForm(){
            if( '' == $.trim($('#title').val())){
                layer.msg('请输入权限名称',{icon:2,time:1500,shade: 0.1}, function(index){
                layer.close(index);
                });
                return false;
            }
...
function del_rule(id){
    layer.confirm('确认删除此权限?', {icon: 3, title:'提示'}, function(index){
        //do something
